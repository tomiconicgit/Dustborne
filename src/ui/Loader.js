...
export default class Loader {
    constructor() {
        ...
        // >>> Wire the Debugger into the loader's log box
    ...
    _createStyles() {
        const styles = `
            ...
            #dustborne-loading-screen {
                ...
                z-index: 10000; /* stays above the debugger overlay (9999) */
            ...
            .dustborne-loader-container {
                width: 90%; max-width: 600px; z-index: 3;
                padding: 15px;
            ...
            #dustborne-status-container {
                ...
                margin-bottom: 8px; font-size: 0.9em; color: #a0a0a0;
            }

            #dustborne-loading-bar-container {
                width: 100%; height: 4px; background-color: #222;
            ...
            #dustborne-log-container {
                ...
                padding: 10px; text-align: left; font-size: 0.8em; color: #ccc;
    ...
    updateStatus(message, progress) {
        ...
        // Add a new line to the loader log
    ...
    fail(error) {
        ...
        // Also push to console (captured by Debugger and mirrored)
